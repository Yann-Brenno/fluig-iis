...
-- Copiando dados para a tabela lab_ti_aec.log: ~1 rows (aproximadamente)
DELETE FROM `log`;
INSERT INTO `log` (`ID`, `cod_rm`, `nome_item`, `qtd_item`, `pat_item`, `comentario`, `usuario`) VALUES
	(41, 3232, '00.0.00', 5546649, '03.07.899', 'Yann retirou ', 'n.yann.ramos'),
	(42, 303000, 'dell 390', 1, '03.07.3233', 'Yann retirou pra um chamado #25656', 'n.yann.ramos');
